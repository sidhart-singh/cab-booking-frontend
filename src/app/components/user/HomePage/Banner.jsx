      ...
      <div className="bannerMiniContainer px-36">
        ...
        <div className="bg-white pt-5">
          <div className="flex items-center justify-around">
            ...
            <div
              // onClick={() => router.push("/")}
              className="searchOlaCabButton cursor-pointer flex items-center py-2 px-14 border border-slate-900 justify-around"
            >
              <p className="text-white font-semibold">
                Search <span className="text-green-400"> Ola Cabs</span>
              </p>
              <ArrowRightAltIcon
